...
import vazdor.form.Strategy;

@FormGenStrategyRender(strategy=Strategy.BOOTSTRAP_GROUP)
public class HTMLFielsPojoBootStrap implements Serializable{

	@FormGenExcludeField
	private static final long serialVersionUID = 6963399912168312135L;
